...
public class TestingRotate : MonoBehaviour
{
    ...
    {
        //method 1 leantween
        var sunLocalForEarth = earth.transform.InverseTransformPoint(sun.transform.position);
        ...
        //method 2 leantween
        var sunLocalForEarth2 = earth2.transform.InverseTransformPoint(sun2.transform.position);
